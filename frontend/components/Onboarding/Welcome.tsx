      ...
      <div className="flex flex-col lg:flex-row min-h-[100dvh] lg:h-screen w-full bg-editorial-bg lg:overflow-hidden">
        ...
        <div className="lg:w-1/2 w-full bg-dot-pattern flex flex-col justify-center px-10 py-16 lg:px-24 lg:h-full lg:overflow-y-auto relative shrink-0">
          ...
          >
            ...
            <h1 className="text-5xl font-bold text-editorial-ink mb-4 leading-tight">
              Welcome to <br />
              Imperium <span className="text-brand-500">news</span>
            </h1>

            <p className="text-editorial-muted text-lg mb-10 max-w-md leading-relaxed">
            ...
            <ul className="space-y-6 mb-12">
              <li className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-brand-500 flex items-center justify-center shrink-0 shadow-lg shadow-brand-500/10">
                  <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <div>
                  <h4 className="font-semibold text-editorial-ink">Real-time updates</h4>
                  <p className="text-sm text-editorial-muted">Breaking news the moment it happens</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-brand-500 flex items-center justify-center shrink-0 shadow-lg shadow-brand-500/10">
                ...
                <div>
                  <h4 className="font-semibold text-editorial-ink">Personalized feed</h4>
                  <p className="text-sm text-editorial-muted">A feed that learns what matters to you</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-brand-500 flex items-center justify-center shrink-0 shadow-lg shadow-brand-500/10">
                ...
                <div>
                  <h4 className="font-semibold text-editorial-ink">Global coverage</h4>
                  <p className="text-sm text-editorial-muted">Every country, every topic — one place</p>
                </div>
              </li>
            </ul>
            ...
            <div className="flex flex-col gap-4 max-w-sm">
              <button
                ...
                className="w-full bg-brand-500 hover:bg-brand-600 text-white font-medium py-3.5 rounded-xl flex items-center justify-center gap-2 transition-colors shadow-lg shadow-brand-500/10 group"
              >
                Get Started
            ...
            <p className="text-xs text-editorial-muted/70 mt-6 max-w-sm text-center">
